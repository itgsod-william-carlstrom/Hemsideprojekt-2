...
| Förmåga                          | E 																																   | C | A |
|----------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|---|---|
| Terminologi	 				   | Du använder, med viss säkerhet, enkel terminologi inom området | Som för E, men mer avancerad terminologi | Som för C, men med säkerhet   |

#### Projektplan ####

| Förmåga                          | E 																																   | C | A |
|----------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|---|---|
| Målsättning					   | Du skapar en enkel målsättning för projektet | Som för E, men målsättningen är genomarbetad | |
| Problemformulering			   | Du skapar en enkel problemformulering utifrån kundens önskemål | Som för E, men du skapar en något mer avancerad problemformulering 	| Som för C, men problemfomuleringen är komplex |
| Målgruppsidentifikation		   | Du gör en enkel identifikation av målgruppen och dess behov |  Som för E, men du gör en något mer avancerad målgruppsidentifikation 	| Som för C, men målgruppsidentifikationen är komplex |
| Målgruppsanpassning 			   | Du skapar en skiss som, med tillfredsställande resultat, är anpassat till användarens behov |  | Som för C, men med gott resultat |
| Anpassning till budskapet  	   | Du skapar en skiss som, på ett tillfredsställande sätt, för fram kundens önskade budskap |  | Som för E, men på ett gott sätt  |
| Anpassning till plattformen 	   | Du följer i skissen någon av de konventioner som finns för den valda plattformen | Som för E, men några konventioner | Som för C, men flera konventioner  |
| Designprinciper 			 	   | Du utformar skissen enligt någon enkel princip för visuell design  | Som för E, men enligt några lite mer avancerade principer för användbarhet | Som för C, men enligt flera komplexa principer för användbarhet |
| Användarupplevelse 			   | Du redogör översiktligt för hur skissen förhåller sig till generella principer för hur en god användarupplevelse skapas | Som för E, men utförligt | Som för C, men utförligt och nyanserat, och du ger dessutom förslag på hur resultatet kan förbättras |

#### Interaktiv prototyp ####

| Förmåga                       | E 																																   | C | A |
|-------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|---|---|
| Funktion 						| Du skapar en interaktiv prototyp med tillfredsställande funktionalitet  |  | Som för E, men med god funktionalitet   |
| Utseende 						| Du skapar en interaktiv prototyp med tillfredsställande utseende | | Som för E, men med gott utseende |
| Inklusivitet 					| Du anpassar, med tillfredsställande resultat, den visuella designen och interaktionen till användare med funktionsnedsättningar |  | Som för E, men med gott resultat |
| Användbarhetstestning 		| Du testar, med några enkla metoder, prototypens användbarhet |   | Som för E, men flera olika, lite mer anvancerade metoder, och återkopplar dessutom resultatet av testningen till din design  |
| Målgruppsanpassning 			| Du skapar ett gränssnitt som, med tillfredsställande resultat, är anpassat till användarens behov |  | Som för C, men med gott resultat |
| Anpassning till budskapet  	| Du skapar ett gränssnitt som, på ett tillfredsställande sätt, för fram kundens önskade budskap |  | Som för E, men på ett gott sätt  |
| Anpassning till plattformen 	| Du följer någon av de konventioner som finns för den valda plattformen | Som för E, men några konventioner | Som för C, men flera konventioner  |
| Designprinciper 			 	| Du utformar gränssnittet enligt någon enkel princip för visuell design  | Som för E, men enligt några lite mer avancerade principer för användbarhet | Som för C, men enligt flera komplexa principer för användbarhet |
| Stilguide 					| Du skapar till prototypen en stilguide som täcker någon av designens viktigaste delar | Som för E, men stilguiden täcker några av designens viktigaste delar | Som för C, men stilguiden täcker flera av designens viktigaste delar   |
...
Dokumentationen skall visa hur skissen/prototypen är baserad på CRAP och Rule of Thirds
